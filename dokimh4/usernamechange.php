					...
					<div class="card bg-dark text-white" style="border-radius: 1rem;">
						<div class="card-body p-5 text-center">	
							<div class="mb-md-5 mt-md-4 pb-5">
								...
								<h4 class="text-white-50 mb-5"> Update your username </h4>
                                ...
                                <div class="form-outline form-white mb-4">
									<label class="form-label">Verify your email address</label>
								...
								<br>
								<div class="form-outline form-white mb-4">
									<button type="submit" class="btn btn-outline-light btn-lg px-5" name="updatename_btn">Confirm Changes</button>
								</div>
							</div>	
						</div>	
					</div>
