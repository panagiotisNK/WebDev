...
CREATE TABLE poiCoordinates(
    poiId VARCHAR(30) NOT NULL,
    lat DOUBLE(11,9) DEFAULT 0 NOT NULL,
    lng DOUBLE(11,9) DEFAULT 0 NOT NULL,
    PRIMARY KEY (poiId),
    CONSTRAINT ISAT
    FOREIGN KEY (poiId) REFERENCES poi(poiId)
    ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE popularTimes(
    ...
    dataVal0 INT(10) DEFAULT 00 NOT NULL,
    dataVal1 INT(10) DEFAULT 00 NOT NULL,
    dataVal2 INT(10) DEFAULT 00 NOT NULL,
    dataVal3 INT(10) DEFAULT 00 NOT NULL,
    dataVal4 INT(10) DEFAULT 00 NOT NULL,
    dataVal5 INT(10) DEFAULT 00 NOT NULL,
    dataVal6 INT(10) DEFAULT 00 NOT NULL,
    dataVal7 INT(10) DEFAULT 00 NOT NULL,
    dataVal8 INT(10) DEFAULT 00 NOT NULL,
    dataVal9 INT(10) DEFAULT 00 NOT NULL,
